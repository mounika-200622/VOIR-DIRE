...
VOIDDIRE_BASE_URL  default http://localhost:11434/v1
VOIDDIRE_MODEL     default qwen2.5-coder:7b
VOIDDIRE_API_KEY   optional (Groq / Cerebras / OpenRouter / Gemini-compat)
"""
...
BASE = os.environ.get("VOIDDIRE_BASE_URL", "http://localhost:11434/v1").rstrip("/")
MODEL = os.environ.get("VOIDDIRE_MODEL", "qwen2.5-coder:7b")
KEY = os.environ.get("VOIDDIRE_API_KEY", "")
